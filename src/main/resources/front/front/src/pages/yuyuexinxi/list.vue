...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"0 0 0px","margin":"20px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","justifyContent":"center","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"1"}'>
	  ...
	  <el-button v-if="btnAuth('yuyuexinxi','新增')" :style='{"cursor":"pointer","border":"0px solid #ccc","padding":"0px 8px","margin":"0px 10px 0 0","color":"#666","display":"inline-block","outline":"none","borderRadius":"20px","background":"#fff","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/yuyuexinxiAdd')"><i v-if="true" :style='{"color":"#666","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"minHeight":"900px","padding":"20px 0 0 0","margin":"0","background":"none","flex":"1","width":"calc(100% - 250px)","order":"6"}'>
		...
		<div class="list1 index-pv1" :style='{"width":"100%","padding":"0 0px","fontSize":"14px","color":"#666","background":"none","height":"auto"}'>
			<div :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0 0 10px","margin":"0 2% 20px 0","overflow":"hidden","background":"#fff","display":"inline-block","width":"23%","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 10px","borderColor":"#ddd","margin":"0 0 6px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","borderWidth":"0 0 0px","width":"100%","lineHeight":"24px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}' class="name ">{{item.yuyueshijian}}</div>
				...
				<div :style='{"padding":"0 10px","display":"inline-block"}'>
				  ...
				  <span class="text" :style='{"color":"#f00","lineHeight":"1.5","fontSize":"inherit"}'>{{item.zhanghao}}</span>
				</div>
			</div>
		</div>
...
<script>
  export default {
    ...
    async created() {
		...
		this.selectOptionsList.push({name:'到场状态',list:this.daochangzhuangtaiOptions,tableName: 'daochangzhuangtai',check: -1})
      this.getFenlei();
      this.getList(1, '全部');
    },
    //方法集合
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.daochangzhuangtai != '') searchWhere.daochangzhuangtai = this.formSearch.daochangzhuangtai;
		if(!this.centerType){
			params['sfsh'] = '是';
		}
        ...
        this.$http.get(`yuyuexinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/yuyuexinxiDetail', query: params});
      },
