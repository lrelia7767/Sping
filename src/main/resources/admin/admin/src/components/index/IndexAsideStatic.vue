	...
	mounted() {
		...
		this.$http({
			...
			if (data && data.code === 0) {
				...
				if(sessionTable == 'changdiguanliyuan') {
					this.avatar = data.data.touxiang
				}
