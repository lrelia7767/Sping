<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","top":"2px","textAlign":"center","left":"7%","background":"none","display":"block","width":"auto","position":"absolute","order":"1"}'>
			...
			<span class="title-name" :style='{"padding":"0px","lineHeight":"60px","fontSize":"18px","color":"#fff","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"padding":"0px","fontSize":"inherit","color":"inherit","background":"none","display":"inline-block","order":"10"}'>
		  <div class="el-dropdown-link" :style='{"border":"0px solid #F1F2F7","padding":"0","alignItems":"center","borderRadius":"4px","background":"url() no-repeat right center","display":"flex"}'>
		    <el-image v-if="user" :style='{"border":"0px solid #727b84","margin":"0 10px","objectFit":"cover","borderRadius":"100%","display":"inline-block","width":"40px","height":"40px"}' :src="avatar?this.$base.url + avatar : require('@/assets/img/avator.png')" fit="cover"></el-image>
		    <span :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","display":"block"}'>{{this.$storage.get('adminName')}}</span>
