	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="备注" prop="beizhu">
					<el-input v-model="ruleForm.beizhu" placeholder="备注" clearable  :readonly="ro.beizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="备注" prop="beizhu">
					<el-input v-model="ruleForm.beizhu" placeholder="备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="到场时间" prop="daochangshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.daochangshijian" 
						type="datetime"
						:readonly="ro.daochangshijian"
						placeholder="到场时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.daochangshijian" label="到场时间" prop="daochangshijian">
					<el-input v-model="ruleForm.daochangshijian" placeholder="到场时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="离场状态" prop="lichangzhuangtai">
					<el-select :disabled="ro.lichangzhuangtai" v-model="ruleForm.lichangzhuangtai" placeholder="请选择离场状态" >
						<el-option
							v-for="(item,index) in lichangzhuangtaiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="离场状态" prop="lichangzhuangtai">
					<el-input v-model="ruleForm.lichangzhuangtai"
						placeholder="离场状态" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		return {
			...
			ro:{
				...
				shoujihaoma : false,
				beizhu : false,
				daochangshijian : false,
				lichangzhuangtai : false,
			},
	...
	created() {
		this.ruleForm.daochangshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='daochangshijian'){
							this.ruleForm.daochangshijian = obj[o];
							this.ro.daochangshijian = true;
							continue;
						}
						if(o=='lichangzhuangtai'){
							this.ruleForm.lichangzhuangtai = obj[o];
							this.ro.lichangzhuangtai = true;
							continue;
						}
				}
				this.ruleForm.lichangzhuangtai = '待离场'; 			}
			// 获取用户信息
			this.$http({
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `daochangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.daochangxinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
