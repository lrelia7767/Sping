	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","fontSize":"14px","color":"#666","background":"#fff"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="到场时间" prop="daochangshijian">
					<el-input v-model="ruleForm.daochangshijian" placeholder="到场时间" clearable  :readonly="ro.daochangshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="到场时间" prop="daochangshijian">
					<el-input v-model="ruleForm.daochangshijian" placeholder="到场时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="离场备注" prop="lichangbeizhu">
					<el-input v-model="ruleForm.lichangbeizhu" placeholder="离场备注" clearable  :readonly="ro.lichangbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="离场备注" prop="lichangbeizhu">
					<el-input v-model="ruleForm.lichangbeizhu" placeholder="离场备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="离场时间" prop="lichangshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.lichangshijian" 
						type="datetime"
						:readonly="ro.lichangshijian"
						placeholder="离场时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 30px 20px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.lichangshijian" label="离场时间" prop="lichangshijian">
					<el-input v-model="ruleForm.lichangshijian" placeholder="离场时间" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='lichangbeizhu'){
							this.ruleForm.lichangbeizhu = obj[o];
							this.ro.lichangbeizhu = true;
							continue;
						}
						if(o=='lichangshijian'){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `lichangxinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.lichangxinxiCrossAddOrUpdateFlag = false;
											this.parent.search();
