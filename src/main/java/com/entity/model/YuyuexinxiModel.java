...
public class YuyuexinxiModel  implements Serializable {
	...
	private String daochangzhuangtai;
	...
	public void setDaochangzhuangtai(String daochangzhuangtai) {
		this.daochangzhuangtai = daochangzhuangtai;
	}
	
	/**
	 * 获取：到场状态
	 */
	public String getDaochangzhuangtai() {
		return daochangzhuangtai;
	}
